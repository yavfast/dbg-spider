...
The Initial Developers of the Original Code are
    ...
    MÂrten Henrichson (TAABGraph)

Contributor(s):
    Warren Postma (warrenpstma att hotmail dott com)
    MÂrten Henrichson/AABSoft (no email known)

    Contains some code which is
        (C) 1996-1998 AABsoft and MÂrten Henrichson
...
const
  UnitVersioning: TUnitVersionInfo = (
    ...
    Date: '$Date: 2012-02-24 11:09:08 +0100 (ven. 24 f√©vr. 2012) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}
